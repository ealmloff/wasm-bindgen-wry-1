# wasm-bindgen upgrade to 0.2.127

- Current vendored version: 0.2.121
- Target upstream release/ref: 0.2.127
- Workflow run: https://github.com/ealmloff/wasm-bindgen-wry-1/actions/runs/31379761886
...
```text
Cloning into '/home/runner/work/_temp/wasm-bindgen-upgrade.Dr7zT0/upstream-wasm-bindgen'...
```

### Checked out upstream 0.2.127

```text
Note: switching to '0.2.127'.
...
HEAD is now at a579ee62b Release 0.2.127 (#5219)
```

### Normalized wasm-bindgen patch versions

```text
Normalized 4 patch file(s) from base 49457f2db4465688cb597e9030ccfdefbd2b662e to a579ee62b631fd1fa96c7740b52a2952b07c0219.
