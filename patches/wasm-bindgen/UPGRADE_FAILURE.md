...
- Workflow run: https://github.com/ealmloff/wasm-bindgen-wry-1/actions/runs/28366958513
...
```text
Cloning into '/home/runner/work/_temp/wasm-bindgen-upgrade.p5wuw3/upstream-wasm-bindgen'...
```
...
```text
Normalized 4 patch file(s) from base 49457f2db4465688cb597e9030ccfdefbd2b662e to 21ac804a96c0c5c5d6459084686a9a17a8a3c865.
